...
module.exports = "/* You can add global styles to this file, and also import other style files */\nbody {\n  background-color: #F7F8E0; }\n* {\n  padding: 0;\n  margin: 0;\n  vertical-align: baseline;\n  list-style: none;\n  border: 0; }\n.ladoSlide {\n  background-color: #F7F8E0; }\n.navbar, .page-footer {\n  background-color: green; }\n.page-footer {\n  background-color: #F2F2F2; }\n.nav-item.active:hover {\n  background-color: #0B6121;\n  border-radius: 5px; }\n.card:hover, .carousel.slide:hover, .grid-container > div:hover {\n  box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5); }\n.btn {\n  background-color: #F7F8E0; }\n.item1 {\n  grid-area: left; }\n.item2 {\n  grid-area: menu; }\n.item3 {\n  grid-area: main; }\n.item4 {\n  grid-area: right; }\n.item5 {\n  grid-area: footer; }\n@media (min-width: 992px) {\n  .item1 {\n    -ms-grid-row: 3;\n    -ms-grid-column: 6; }\n  .item2 {\n    -ms-grid-row: 1;\n    -ms-grid-row-span: 3;\n    -ms-grid-column: 1;\n    -ms-grid-column-span: 4; }\n  .item3 {\n    -ms-grid-row: 1;\n    -ms-grid-column: 5; }\n  .item4 {\n    -ms-grid-row: 1;\n    -ms-grid-column: 6; }\n  .item5 {\n    -ms-grid-row: 3;\n    -ms-grid-column: 5; } }\n@media (min-width: 56px) {\n  .card-columns {\n    -webkit-column-count: 1;\n            column-count: 1; }\n  .grid-container {\n        grid-template-areas: !important 'menu menu menu menu menu menu' 'main main main main main main' 'right right right right right right' 'footer footer footer footer footer footer' 'left left left left left left'; }\n  .grid-container > div {\n    margin: 10px 5px 10px 5px; }\n  .carousel-caption {\n    text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black; } }\n@media (min-width: 768px) {\n  .card-columns {\n    -webkit-column-count: 2;\n            column-count: 2; } }\n@media (min-width: 992px) {\n  .card-columns {\n    -webkit-column-count: 3;\n            column-count: 3; }\n  .cardMaior-columns {\n    -webkit-column-count: 1 !important;\n            column-count: 1 !important;\n    background-color: red !important; }\n  .grid-container {\n    display: -ms-grid;\n    display: grid;\n        grid-template-areas: 'menu menu menu menu main right' 'menu menu menu menu footer left';\n    grid-gap: 10px;\n    background-color: #F7F8E0;\n    padding: 10px; }\n  .grid-container > div {\n    background-color: rgba(255, 255, 255, 0.8);\n    text-align: center;\n    font-size: 30px; } }\n"
...
module.exports = __webpack_require__(/*! C:\Users\Folha Oeste\Desktop\sites\angular\SinglePageAngular2\src\styles.scss */"./src/styles.scss");
